#!/bin/bash
# Set up a cosmovisor service to join the hunterverse-1 chain.
...
NODE_MONIKER=hunterverse-node
# ***

CHAIN_BINARY_URL='https://github.com/blockhunters-org/ics-testnets/raw/main/game-of-chains-2022/hunterverse/hunterverse'
