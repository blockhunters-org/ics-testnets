#!/bin/bash
# Set up a hunterbank service to join the hunterbank-1 chain.
...
echo "Description=hunterbank service"       | sudo tee /etc/systemd/system/$NODE_MONIKER.service -a
...
echo "***********************"
echo "After you have updated the genesis file, start the hunterbank service:"
